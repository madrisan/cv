...
\item{\bdot} Full Stack Web Development and responsive Web Design, Hybrid Mobile
             ...
             Ionic, Cordova, NodeJS, MongoDB, and a bunch of other tools in the
             background like Gulp, Bower, nmp, less, $\dots$);
\item{\bdot} Big Data Analysis and Technologies~(Spark, Hadoop, R, HBase, $\dots$),
             Machine Learning;
...
\certauthority{The Hong Kong University of Science}{Coursera}
    \certitem{HTML, CSS and JavaScript}
    \certitem{Front-End Web UI Frameworks and Tools}
    \certitem{Front-End JavaScript Frameworks: AngularJS}
    \certitem{Multiplatform Mobile App Development with Web Technologies}
