...
\noindent I'm currently busy playing with SaltStack, Angular2/Node.js and
Web technologies in general, and improving my knowledge of the Scala language,
but my interests in technology and maths fields cover the following areas:
...
\item{\bdot}
    DevOps, Docker containerization and Infrastructure as Code (IaC) Technologies;
\item{\bdot}
