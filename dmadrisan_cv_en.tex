...
Develop some Salt state modules and libraries for a better integration of
GitLab~CI and HashiCorp~Vault HA (with HashiCorp~Consul and Apache ZooKeeper as secure
storage backends).
...
HashiCorp Vault and Consul, Jenkins, MariaDB, NGiNX, Phusion Passenger, SaltStack,
Swarm, Unbound, uWSGI, ZooKeeper;
