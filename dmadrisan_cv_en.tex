...
\personaldata{%
   ...
   \personaldataline{\fafiveLinkedIN}{
            LinkedIn Profile}{\tt https://www.linkedin.com/in/madrisan}
   \personaldataline{\fafiveGitHub}{
            GitHub Public Repositories}{\tt https://github.com/madrisan}
   \personaldataline{\fafiveWeb}{Personal Website}{
            \tt https://madrisan.com}
...
\subsection{An annotated scatter plot that should help visualizing my job and
learning activities}
% (I'm an MOOC-addoct) activities}
...
\tinyskip\noindent
\technologies
Linux RHEL/CentOS/Debian, RedHat Cluster Suite, Docker containers,
