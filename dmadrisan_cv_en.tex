...
\personaldata{%
  ...
  %\personaldataline{                 }{\tt https://sites.google.com/site/davidemadrisan\hbox to 7.5mm{\hss${}^{(old)}$}}
   ...
   \personaldataline{Personal Technical Blog}{\tt https://madrisan.com/blog/}
}
...
%\eightpoint
\item{\bdot}
    Maths, currently digging around Dynamic Systems, Chaos Theory, Fractals and Scaling;
\item{\bdot}
    DevOps, Docker containers and Infrastructure \& Configuration as Code Technologies;
\item{\bdot}
