...
\item{\bdot} Full Stack Web Development and responsive Web Design, Hybrid Mobile
             App Development (CSS3, Bootstrap, JavaScript, jQuery, AngularJS,
             Ionic, Cordova, NodeJS, Express, MongoDB, and a bunch of other tools in the
             background like Gulp, Bower, nmp, less, $\dots$);
\item{\bdot} Machine Learning, Big Data Analysis and Technologies~(Spark, Hadoop, R,
             HBase, $\dots$),
\item{\bdot} Python programming;
\item{\bdot} Cloud Computing Technologies and IoT Linux-based devices;
\item{\bdot} Functional and concurrent programming (Scala and AKKA);
\item{\bdot} Distributed Systems and GPGPU Programming
             (CUDA C\plusplus{} programming and OpenCL);
...
\certauthority{University of Illinois at Urbana-Champaign}{Coursera}
   \certitem{Cloud Computing Applications \& Cloud Networking}
\smallskip
...
\certauthority{Universit\'e catholique de Louvain}{edX}
  \certitem{Paradigms of Computer Programming -- Fundamentals \& Abstraction and Concurrency}
\goodbreak
