...
%%% Copyright (C) 2017-2024 by Davide Madrisan <d.madrisan@proton.me>
...
\personaldata{%
   ...
   \personaldataline{\fafiveUniversity}{Education}{
            Master of Science in Mathematics / DMA in Piano Performance}
   \personaldataline{\fafiveHandshake}{Languages}{
            Italian ({\it native\/}),
            French ({\it fluent\/}),
            English ({\it good working knowledge\/})}
   \personaldataline{\fafiveLinkedIN}{
            LinkedIn Profile}{\pdfurl{linkedin.com/in/madrisan}}
   \personaldataline{\fafiveGitHub}{
            GitHub Public Repositories}{\pdfurl{github.com/madrisan}}
   \personaldataline{\fafiveWeb}{Personal Website}{
            \pdfurl{madrisan.github.io}}
...
\footnote{\rm$^{(\negthinspace*\negthinspace)}$}{%
    ...
    {\eightpoint\pdfurl{github.com/madrisan/cv}}}%
%
...
Software and Data Engineer at Qwant}
\leftline{\bf\color{darkgray}%
Linux Open Source Developer with 25 years of experience}
...
\hbox{DevOps}, and finally Kubernetes, CI/CD technologies, Data Analysis with Python,
...
I'm currently busy playing with GitLab~CI, ArgoCD, Argo Workflows, Helm,
 Kubernetes, Docker, SaltStack, Go, cloud technologies, and improving my
knowledge in functional programming, but my interests in technology and
maths/physics fields cover the following areas
...
\item{\bdot}
    DevOps, Kubernetes, Configuration as Code Technologies, CI/CD;
\item{\bdot}
    (Piano) music from Baroque to Modern and Music Typesetting with {\it Lilypond}.
%\item{\bdot}
...
\dateitem{June~2023}{current}{Software \& Data Engineer~@~Qwant.com}

\stress{Software and Data Engineer} at Qwant (\pdfurl{www.qwant.com}),
the French internet company that develops the eponymous web search engine that
respects the users' privacy.

\smallskip\noindent
\tasks
Maintenance of the Qwant CI/CD and Analytics infrastructure.
Kubernetes deployments of internal and public services.
Development of Python software that interacts with ClickHouse clusters to import
and manipulate data.
Creation of Argo workflows for automating recurring actions.

\smallskip\noindent
\technologies
ArgoCD, Argo~Workflows, ClickHouse, Git, GitLab~CI,
HashiCorp Vault, Helm, Kaniko, Kubernetes, Metabase, Pandas, PostgreSQL,
Python (Poetry, Pylint, Pytest, $\dots$), Trivy, ZK.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\dateitem{May~2020}{May~2023}{Software Engineer~@~Qwant.com}

\stress{Software Engineer} at Qwant.
\smallskip\noindent
\tasks
Continuous integration and deployment on Kubernetes with
GitLab CI (automated pipelines), Helm, ArgoCD, and Argo~Workflows.
Tasks related to Software Quality control.

\smallskip\noindent
\software
\pdfurl{github.com/madrisan/go-mattermost-notify} --
A simple Mattermost notifier written in Go.

\smallskip\noindent
\technologies
ArgoCD, Argo~Workflows, ClickHouse, Docker, Dremio, Git, GitLab~CI, Grafana,
HashiCorp Vault, Kafka, Helm~Charts, Kaniko, Kubernetes, MariaDB, Metabase,
MinIO, Podman, PostgreSQL, Prometheus, Trivy, $\dots$

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\dateitem{September~2017}{April 2020}{Site Reliability Engineer~@~Qwant.com}

\stress{Site Reliability Engineer} and \stress{Infra Lead DevOps\/} at Qwant.
...
\dateitem{April~2013}{April 2021}{\OS2--Open Source Solutions (micro entreprise)}
...
\smallskip\noindent
\software
\pdfurl{github.com/madrisan/saltstack-code-snippets} --
SaltStack code snippets for Linux.

\tinyskip\noindent
\pdfurl{github.com/madrisan/pyxymon} --
...
\smallskip\noindent
\software
\pdfurl{github.com/madrisan/nagios-plugins-linux} --
...
%(\pdfurl{www.openmamba.org}) to the Raspberry~Pi.
...
\smallskip\noindent
\software
\pdfurl{gitlab.mambasoft.it/openmamba/autospec} --
...
%For more details:
%\pdfurl{sites.google.com/site/davidemadrisan/linux}.
...
\smallskip\noindent
\software
\pdfurl{github.com/madrisan/TeX-macros/tree/master/astmacro} --
...
\bgroup\eightpoint
%  2 Dec 2022
\certification{2022.}{Build JavaScript applications using TypeScript) -- {\it Microsoft}}
% 21 jul 2021
\certification{2021.}{Introduction to GitOps (LFS169) -- {\it Linux Foundation}}
% 29 may 2021
\certification{2021.}{Urban Nature: Connecting Cities, Nature and Innovation -- {\it Lund University}}
% 22 may 2021
\certification{2021.}{Greening the Economy: Sustainable Cities -- {\it Lund University}}
%  8 may 2021
\certification{2021.}{Greening the Economy: Lessons from Scandinavia -- {\it Lund University}}
% 19 april 2021
\certification{2021.}{Giving Helpful Feedback -- {\it University of Colorado Boulder}}
%  4 april 2021
\certification{2021.}{Understanding Dementia -- {\it The Wicking Demence Centre, University of Tasmania}}
% 26 january 2021
\certification{2021.}{Introduction to solar cells -- {\it Technical University of Danemark}}
% 05 november 2010
