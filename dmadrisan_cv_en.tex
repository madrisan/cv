...
\vglue 1.0truemm
\line{\titlefont Curriculum Vit\ae{} et Studiorum%
\footnote{\rm$^{(*)}$}{\eightit%
The online version of this Curriculum Vit\ae{} is available at\/
{\eighttt https://github.com/madrisan/cv}}\hfill{\eightit\today}}

\vskip 10truemm plus2truemm minus2truemm
\rightline{\bf%
Lead DevOps and Automation Engineer, Open Source Developer}
...
\personaldata{%
   ...
   \personaldataline{Email address}{\tt davide\kern-.0pt{.}\kern-.0pt{madrisan}%
...
Performance and then moving on into Cisco WAN Networking and Network Security,
Linux System Development and Administration, Nagios/Centreon Monitoring, Linux 
Embedded Systems, Full~Stack Web Development, and Linux DevOps technologies,
...
I'm currently busy playing with SaltStack, Docker, Go, OpenStack,
...
\item{\bdot}
    ...
    Cosmology, superstring theory and \hbox{M--theory};
\item{\bdot}
...
\dateitem{September~2017}{current}{Lead DevOps @ Qwant.com}
...
\vskip 0pt\noindent
Software-define {\it everything\/} with SaltStack: from infrastructure to software
integration, deployment, and testing.
Develop some Salt state modules and libraries for a better integration with
GitLab~CI, HashiCorp~Vault HA (with HashiCorp~Consul and Apache ZooKeeper as secure
storage backends), phpIPAM, and for deploying VMware Virtual Servers.
...
HashiCorp Vault and Consul, Jenkins, MariaDB, NGiNX, phpIPAM, Phusion Passenger,
SaltStack, Salt Cloud, Swarm, Unbound, uWSGI, ZooKeeper;
