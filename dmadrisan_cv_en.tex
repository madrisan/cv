...
Embedded System and MEAN~Stack Web Development, 
...
but my broad areas of interest in maths and technology fields are
the following ones:

\item{\bdot}
    Maths, currently digging around Dynamic Systems and Chaos Theory;
\item{\bdot}
    MEAN Stack Web Development and responsive Web Design
...
\item{\bdot} Travis~CI, Jenkins~CI, Git/GitLab, JSON, Python,
             Responsive Web Design~(HTML5, Bootstrap, CSS3/Less, AngularJS).
