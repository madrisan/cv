...
\def\colordarkgreen{rgb 0 0.5 0}
...
\def\sectionrule{\horizontalrule{2}{50}}
...
\long\def\section#1 \par {%
    \goodbreak\bigskip%
    \leftline{\color{darkgreen}\sectionrule\quad\sectionfont#1}%
    \penalty-200%
...
\font\sectionfont = cmss10 % cmssbx10 % cmbx10
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
