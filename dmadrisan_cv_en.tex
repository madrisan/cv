...
Software and Site Reliability Engineer at Qwant}
\leftline{\bf\color{darkgray}%
...
\stress{Software and Data Engineer} at Qwant (\url{www.qwant.com}),
the French internet company that develops the eponymous web search engine that
respects the users' privacy.

\smallskip\noindent
\tasks
Maintenance of the Qwant Analytics infrastructure.
...
\smallskip\noindent
\technologies
ArgoCD, Argo~Workflows, ClickHouse, ClickHouse Operator, Git, GitLab~CI,
HashiCorp Vault, Helm, Kaniko, Kubernetes, Metabase, PostgreSQL, Python,
Trivy, ZooKeeper.
...
\smallskip\noindent
\software
\url{github.com/madrisan/TeX-macros/tree/master/astmacro} --
