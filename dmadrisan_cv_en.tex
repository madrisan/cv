...
\personaldata{%
   ...
   \personaldataline{\fafiveLinkedIN}{
            LinkedIn Profile}{\url{https://www.linkedin.com/in/madrisan}}
   \personaldataline{\fafiveGitHub}{
            GitHub Public Repositories}{\url{https://github.com/madrisan}}
   \personaldataline{\fafiveWeb}{Personal Website}{
            \url{https://madrisan.com}}
   \personaldataline{\fafiveMail}{
            Email address}{\tt davide\kern-.0pt{.}\kern-.0pt{madrisan}%
...
\footnote{\rm$^{(*)}$}{%
    ...
    {\eighttt \url{https://github.com/madrisan/cv}}}%
%
\space --- {\fiverm\today}\hfill}
...
in Pia\-no, and then moving on into Cisco WAN networking and
network security, Linux di\-stri\-bu\-tion development,
Linux administration, Nagios/Centreon monitoring,
Linux embedded systems, Full~Stack Web development,
...
Infra Data and IT Lead DevOps at Qwant (\url{http://www.qwant.com}), the
...
HashiCorp Vault Monitoring Tool (written in Go).

\noindent
\url{https://github.com/madrisan/debian-packages} --
...
an open source framework (back--end in Python and JSON, front--end in
...
{\it Technical Leader\/} of the {\it Nagios monitoring team\/}
(France and Poland).
{\it Focal point\/} of the monitoring technologies based on open source solutions and
software.
...
\tinyskip\noindent
Develop shell and Python scripts and C (system level) programs.
...
\tinyskip\noindent
Improve the security of the core and Nagios servers, apache 
services and applications.

\tinyskip\noindent
Administer all the monitoring configuration
(5k\smallplus~hosts; 60k\smallplus~monitored services).
...
\smallskip\noindent
\software
Open source extensions to the {\it Nagios Plugins\/} official software for
...
\dateitem{November 2008}{September 2011}{L3 Linux System Administrator at IBM}
...
Leader of the team that developed QiLinux~2.0, the derived commercial 
