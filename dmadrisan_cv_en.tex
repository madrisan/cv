...
\def\certspecialization#1{%
   \vskip -3pt\noindent\ignorespaces\hskip\parindent{\bf#1}}
\def\certitembullet#1{\bitemitemunamed{#1}}
\def\certitem#1{%
   \vskip -3pt\noindent\ignorespaces\hskip\parindent{\bf#1}}
...
\item{\bdot} GNU/Linux and Open source Technologies;
\item{\bdot} Cloud Computing Technologies;
\item{\bdot} Machine Learning, (Big)~data Analysis and Technologies;
...
\certauthority{Universidad Carlos III de Madrid}{edX}
   \certitem{Introduction to Programming with Java.}
\certauthority{The Hong Kong University of Science and Technology}{edX}
   \certitem{Introduction to Java Programming.}
...
\certauthority{University of Illinois at Urbana-Champaign}{Coursera}
   \certitem{\bf Heterogeneous Parallel Programming;}
   \certitem{\bf Cloud Computing Applications.}
